...
export const RajkotMapSection: React.FC = () => {
  ...
  const rajkotAddress =
    "Digi Basera Marketing Agency, Chandresh Nagar Main Road, Mayani Chowk, Opposite Backbone Shopping Centre, Rajkot - 360004, Gujarat, India";
  const googleMapsUrl = "https://share.google/6qE9KBy6hSqJnPcZ2";
  const mapEmbedSrc =
    "https://maps.google.com/maps?q=Chandresh%20Nagar%20Main%20Road%2C%20Mayani%20Chowk%2C%20Opposite%20Backbone%20Shopping%20Centre%2C%20Rajkot%20360004&t=&z=16&ie=UTF8&iwloc=&output=embed";
              ...
              <div className="space-y-4 text-xs">
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[11px] text-[#777777] mt-0.5 font-normal">Gujarat, India</p>
                  </div>
                </div>
